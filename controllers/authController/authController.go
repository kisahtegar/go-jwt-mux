...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	expTime := time.Now().Add(time.Minute * 1) // token expired 1 minute
	...
	fmt.Println("tokenAlgo:", tokenAlgo)
...
// This used for register endpoint.
